...
public partial class NMobileTheme : Styles
{
    ...
    public NMobileTheme() : this(SukiColor.Blue,null)
    { }

    public NMobileTheme(SukiColor colorTheme, IEnumerable<SukiColorTheme>? extraColorThemes, bool loadXaml = true)
    {
    ...
    public NMobileTheme ColorTheme(SukiColor sukiColor)
    {
    ...
    public NMobileTheme ColorTheme(SukiColorTheme sukiColorTheme)
    {
    ...
    public NMobileTheme AddColorTheme(SukiColorTheme sukiColorTheme)
    {
    ...
    public NMobileTheme AddColorThemes(IEnumerable<SukiColorTheme> sukiColorThemes)
    {
    ...
    public NMobileTheme BaseTheme(ThemeVariant baseTheme)
    {
    ...
    /// </summary>
    public NMobileTheme SwitchBaseTheme()
    {
